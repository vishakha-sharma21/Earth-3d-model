  ...
  return (
    <>
      ...
      <main ref={mainContainerRef} className="w-full">
        {/* --- Sticky Navbar --- */}
        <nav ref={navRef} className="fixed top-0 left-0 w-full z-50 p-4 opacity-0 -translate-y-full" style={{background: 'rgba(10, 10, 10, 0.5)', backdropFilter: 'blur(10px)'}}>
            <Navbar/>
        </nav>

        {/* --- Hero Section --- */}
        <section ref={heroSectionRef} className="h-screen w-full relative overflow-hidden bg-[#0a0a0a]">
          ...
          <div ref={textContainerRef} className="absolute inset-0 flex flex-col items-center justify-start pt-48 text-center z-10 pointer-events-none">
            <h1 ref={titleRef} className="text-7xl md:text-9xl font-extrabold tracking-tighter opacity-0 text-white relative z-10">
              SeaCreds
            </h1>
            <p ref={subtitleRef} className="text-lg md:text-2xl mt-6 max-w-2xl text-gray-300 opacity-0 relative z-10">
              A next-gen blockchain registry for<br/>ocean and mangrove carbon credits.
            </p>
          </div>

          {/* 3D Canvas Container */}
          <div ref={canvasContainerRef} className="absolute w-full h-full top-0 left-0 z-20">
        ...
        {/* --- Content Section --- */}
        <section ref={contentSectionRef} className="relative z-30 bg-[#0a0a0a] min-h-screen p-8 md-p-16">
          <Mission  />
        </section>
      </main>
      </CustomCursor>
